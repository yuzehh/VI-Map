...
class _LaneNetCluster(object):
    ...
    def _get_lane_embedding_feats(binary_seg_ret, instance_seg_ret):
        ...
        lane_coordinate = np.vstack((idx[0], idx[1])).transpose() # yuzeh
    ...
    def apply_lane_feats_cluster(self, binary_seg_result, instance_seg_result):
        ...
        for index, label in enumerate(unique_labels.tolist()):
            ...
            pix_coord_idx = tuple((coord[idx][:, 0], coord[idx][:, 1])) # yuzeh
...
class LaneNetPostProcessor(object):
    ...
    def postprocess(self, binary_seg_result, instance_seg_result=None, min_area_threshold=100): # 100
        """
        ...
        # TODO: may delete the following check/lower the min_area_threshold: each prediction values
